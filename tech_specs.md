...
État final vérifié sur `feat/validation-integration` : pytest **161/161** en mode normal et **161/161** avec `RAGDOM_LOW_MEMORY=true`; Vitest **17/17**; build TypeScript strict + Vite **8.2.2** vert (**3 711 modules**); `react-router-dom` **7.18.2**; `npm audit` **0 vulnérabilité**.
