...
Preuves finales rejouées après exécution end-to-end : pytest **160/160** normal et **160/160** faible mémoire, Vitest **17/17**, build TypeScript strict + Vite **8.2.2** vert (**3 711 modules**), React Router DOM **7.18.2**, `npm audit` **0 vulnérabilité**.
